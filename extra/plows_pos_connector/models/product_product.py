...
class ProductTemplate(models.Model):
    ...
    x_id_plows = fields.Char(string='ID Plows (Template)', related='x_id_pos', store=True, readonly=False)
...
class ProductProduct(models.Model):
    ...
    x_id_plows = fields.Char(string='ID Plows', related='x_id_pos', store=True, readonly=False)
